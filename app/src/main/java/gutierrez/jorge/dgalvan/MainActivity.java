...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.contenedor,new gutierrez.jorge.dgalvan.Menu()).commit();
        ...
        if(first){
            Intent intent = new Intent(MainActivity.this,FichaAlimenticiaCliente.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            fragment = new gutierrez.jorge.dgalvan.Menu();
            seleccionado = true;
        } else if (id == R.id.nav_mi_carrito) {
            fragment = new MiCarrito();
            seleccionado = true;
        } else if (id == R.id.nav_mi_perfil) {
            Intent intent = new Intent(this,FichaAlimenticiaCliente.class);
            startActivity(intent);
        }
